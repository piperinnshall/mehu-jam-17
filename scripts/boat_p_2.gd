...
func _find_game_manager() -> void:
	...
	if game_manager:
		print("P2: Found GameManager!")
	else:
		print("P2: Could not find GameManager!")
...
func hit_by_cannonball() -> void:
	...
	print("P2: hit_by_cannonball called")
	
	if not game_manager:
		_find_game_manager()
	
	if game_manager and game_manager.has_method("player_hit"):
		print("P2: Calling game_manager.player_hit(2)")
		game_manager.player_hit(2)
	else:
		print("P2: No game manager found, exploding immediately")
		_trigger_explosion()

func _trigger_explosion() -> void:
	print("P2: _trigger_explosion called")
	is_destroyed = true
